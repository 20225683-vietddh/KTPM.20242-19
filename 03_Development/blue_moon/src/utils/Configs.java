...
public class Configs {
	...
	public static final String HOUSEHOLD_LIST_PATH = "/views/household/HouseholdList.fxml";
	...
	public static final String[] STATUS = {"Mãi tạo", "Đang diễn ra", "Đã kết thúc"};
	...
	public static final String[] ETHNICITY = {
		    "Kinh", "Tày", "Thái", "H'Mông", "Mường", "Khmer", "Hoa", "Nùng", "Dao", 
		    "Gia Rai", "Ê Đê", "Ba Na", "Xơ Đăng", "Sán Chay", "Cơ Ho", "Chăm", 
		    "Sán Dìu", "Hrê", "Ra Glai", "Mnông", "Thổ", "Xtiêng", "Khơ Mú", "Bru-Vân Kiều", 
		    "Giáy", "Cơ Tu", "Giẻ Triêng", "Tà Ôi", "Mạ", "Co", "Chơ Ro", "Xinh Mun", 
		    "Hà Nhì", "Chu Ru", "Lào", "La Chí", "La Ha", "Phù Lá", "Lự", "Lô Lô", 
		    "Chứt", "Mảng", "Pà Thẻn", "Cơ Lao", "Cống", "Bố Y", "La Hủ", "Ngái", 
	...
	public static final String ADD_RESIDENT_DIALOG_PATH = "/views/resident/AddResidentDialog.fxml";
	public static final String VIEW_RESIDENT_DIALOG_PATH = "/views/resident/ViewResidentDialog.fxml";
